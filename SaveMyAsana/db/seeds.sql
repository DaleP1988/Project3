...
INSERT INTO instructorSurvey
    (Firstname, Lastname, studio, city, locState, q1, q2, q3, q4, q5, q6)
values
...
INSERT INTO instructorPro
    (Firstname, Lastname, email, phone, city, ste, img, q1, q2, q3, q4, q5, q6, q7)
values
    ("Sarah", "Smith", "123@gmail.com", "(555) 555-5555", "Los Angeles", "CA", "bliss.jpg", "q1", "q2", "q3", "q4", "q5", "q6", "q7");
...
INSERT INTO clientPro
    (Firstname, Lastname, email, phone, city, locState, img, q1, q2, q3, q4)
values
...
INSERT INTO clientSearch
    (Firstname, Lastname, email, phone, city, locState, img)
values
