/*Type definitions for Survey JavaScript library v1.0.56
...
export declare class SurveyQuestionRadiogroup extends SurveyQuestionElementBase {
    ...
    protected getItems(cssClasses: any): Array<any>;
    protected readonly textStyle: any;
    protected renderRadio(key: string, item: ItemValue, isChecked: boolean, otherItem: JSX.Element, isFirst: boolean, cssClasses: any, index: number): JSX.Element;
    protected renderOther(cssClasses: any): JSX.Element;
}
